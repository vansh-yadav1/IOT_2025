...
const mockNotifications: Notification[] = [
  {
    ...
    message: 'You have a doctor appointment with Dr. Mantas tomorrow at 10:00 AM',
...
const NotificationsPage: React.FC = () => {
  ...
  const patientNotifications: Notification[] = [
    {
      ...
      type: 'appointment',
      title: 'Upcoming Appointment',
      message: 'You have a doctor appointment with Dr. Mantas Singh tomorrow at 10:00 AM',
      date: '2023-08-15 09:30',
      read: false,
      urgent: true
    },
  ...
  const doctorNotifications: Notification[] = [
    {
      ...
      type: 'system',
      title: 'New Report',
      message: 'A new report is available for your review.',
      date: '2023-08-15 09:30',
      read: false,
      urgent: false
    },
  ...
  const [notifications, setNotifications] = useState<Notification[]>(
    user?.user_metadata?.role === 'DOCTOR' ? doctorNotifications : patientNotifications
  );
